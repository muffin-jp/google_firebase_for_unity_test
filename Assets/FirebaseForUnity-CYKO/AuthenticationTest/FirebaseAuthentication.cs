...
namespace Scenes.Authentication
{
	public class FirebaseAuthentication : MonoBehaviour {
		...
		[SerializeField] private Text messageLogin;
		[SerializeField] private Text messageUpdate;
		...
		[SerializeField] private InputField nameUpdate;
		[SerializeField] private InputField photoUpdate;
		[SerializeField] private Image profilePic;

		[SerializeField] private InputField emailUpdateInput;
		[SerializeField] private Text emailUpdateMsg;

		[SerializeField] private InputField passwordUpdateInput;
		[SerializeField] private Text passwordUpdateMsg;

		[SerializeField] private GameObject MsgPanel;
		[SerializeField] private Text msgPanelText;
		...
		private static bool CheckError (AggregateException exception, int firebaseExceptionCode)
		{
